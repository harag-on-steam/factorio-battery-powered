...
if is_se then
    charger_discharger({
        ...
        ingredients_charger = {
            ...
            {type = "item", name = "se-holmium-cable", amount = 40},
            {type = "item", name = "processing-unit", amount = 2},
            {type = "item", name = "bp-battery-charger", amount = 1},
        },
    ...
    charger_discharger({
        ...
        ingredients_charger = {
          {type = "item", name = "se-superconductive-cable", amount = 8},
          {type = "item", name = "se-naquium-cube", amount = 1},
          {type = "item", name = "se-quantum-processor", amount = 1},
          {type = "item", name = "bp-holmium-battery-charger", amount = 1},
        },
        ingredients_discharger = {
          {type = "item", name = "se-superconductive-cable", amount = 8},
          {type = "item", name = "se-naquium-cube", amount = 1},
